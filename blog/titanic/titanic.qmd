...
Nous commençons par convertir la variable **Sexe ** en une variable binaire. Ici, nous 
Pour cela, nous créons une nouvelle variable afin de préserver l'intégrité des données d'origine.
