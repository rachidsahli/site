...
sex_counts = titanic.groupby(['Sex', 'Survived']).size().unstack(fill_value=0)

sex_counts.plot(kind='bar', stacked=True, color=['red', 'green'], width=0.6)
...
Enfin, nous remplaçons les deux valeurs manquantes de la variable **Embarked**, représentant le port de départ, par le port de départ majoritaire des passagers.
