...
*Statisticien* \| *Sept 2023 - Sept 2025*<br> 
Au sein de la Direction des statistiques démographiques et sociales, j'ai mené des travaux d'appariement de données administratives. L'objectif de ces travaux était de mesurer et de comparer la couverture de deux bases de sondages. Par ailleurs, j'ai comparé différents algorithmes d'appariement à l'aide d'analyses statistiques.
De plus, j'ai mis en place des modèles de classification exploitant les données administratives afin de réaliser des prédictions.
:::
