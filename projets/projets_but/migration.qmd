...
Le dépôt GitHub contenant le rapport complet du projet, ainsi que les requêtes SQL et NoSQL associées, est disponible [ici](https://github.com/rachidsahli/Projet-datascience/tree/main/Migration_nosql).
