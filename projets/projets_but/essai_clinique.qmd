...
![Schéma de la drépanocytose](image_but/globule_rouge.png){fig-align="center" width="452"}
...
![Résumé descriptif de la population d'étude](image_but/description_essai_clinique.png){fig-align="center" width="500"}
...
![Répartition des traitements dans notre population](image_but/tab_essaiclinique.png){fig-align="center" width="300"}
...
![Représentation graphique du changement ajusté d’hémoglobine entre le départ et la semaine 72](image_but/graph1_essaiclinique.png){fig-align="center" width="491"}
...
![Variations dans les marqueurs d'hémolyse entre la baseline et la semaine 72](image_but/tab_essaiclinique2.png){fig-align="center" width="500"}
...
![Représentation graphique du changement dans les marqueurs d'hémolyse](image_but/graph2_essaiclinique.png){fig-align="center" width="482"}
...
![Programme R du calcul du nombre de patients](image_but/calcul_essaiclinique.png){fig-align="center" width="500"}
